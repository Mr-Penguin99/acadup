    ...
    <div style={{fontFamily:'inherit',minHeight:'100vh',background:'#fff',padding:'24px 28px'}}>
      ...
      <div style={{marginBottom:16}}>
        ...
        <div style={{display:'flex',justifyContent:'flex-end',gap:8}}>
          <button className="sts-search-btn" style={{fontWeight:500}} onClick={()=>{ if(!cancelReason.trim()){alert('결제 취소사유를 입력해주세요.'); return;} alert('결제취소 처리되었습니다.'); window.close(); }}>결제취소하기</button>
      ...
      <table style={{width:'100%',borderCollapse:'collapse',fontSize:13}}>
        ...
        <tbody>
          <tr style={{borderBottom:'1px solid #f0f0f0'}}>
            ...
            <td style={{padding:'8px 12px',textAlign:'center'}}>{data?.payAmt || '170,000'}</td>
          </tr>
        </tbody>
      </table>
