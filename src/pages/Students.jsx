      ...
      <div className="students-body">
        ...
        <div className="students-main">
          ...
          {['notice-board','notice-talk','notice-replace','notice-schedule'].includes(activeSide)&&(
            <div style={{background:'#f8f9fb',border:'1px solid #ff9000',borderRadius:4,padding:'9px 16px',marginBottom:12,fontSize:15,color:'#ff9000',display:'flex',alignItems:'center',justifyContent:'space-between'}}>
