  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', padding: 16, gap: 20 }}>

          {/* 사진 */}
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, flexShrink: 0 }}>
            <div style={{
              width: 120, height: 140, border: '1px solid #ddd',
              borderRadius: 4, background: '#f0f0f0',
              ...
              <tbody>
                <tr>
                  ...
                  <td style={valueStyle}>
                    <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                      <input style={{ ...inputStyle, width: 120 }} value={form.resId1} onChange={e => setForm(f => ({ ...f, resId1: e.target.value }))} />
                      <span>-</span>
                      <input style={{ ...inputStyle, width: 120 }} value={form.resId2} type="password" onChange={e => setForm(f => ({ ...f, resId2: e.target.value }))} />
                      <span style={{ color: '#aaa', fontSize: 11 }}>예) 901230-12...</span>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style={valueStyle}>
                    <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                      ...
                      <span style={{ color: '#aaa', fontSize: 11 }}>예) 010-1234-5678</span>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td colSpan={3} style={valueStyle}>
                    <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                      <input style={{ ...inputStyle, width: 140 }} value={form.email1} onChange={e => setForm(f => ({ ...f, email1: e.target.value }))} />
                      <span>@</span>
                      <input style={{ ...inputStyle, width: 140 }} value={form.email2} onChange={e => setForm(f => ({ ...f, email2: e.target.value }))} />
                ...
                <tr>
                  ...
                  <td colSpan={3} style={valueStyle}>
                    ...
                    <input style={{ ...inputStyle, width: '100%', marginBottom: 6 }} value={form.addr} onChange={e => setForm(f => ({ ...f, addr: e.target.value }))} />
                    <input style={{ ...inputStyle, width: '100%' }} value={form.addrDetail} placeholder="상세주소를 입력해 주세요." onChange={e => setForm(f => ({ ...f, addrDetail: e.target.value }))} />
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
          <tbody>
            <tr>
              ...
              <td style={valueStyle}>{form.empStatus}</td>
            ...
            <tr>
              <td style={{ ...labelStyle, verticalAlign: 'top', paddingTop: 12 }}>약력사항</td>
              <td colSpan={3} style={valueStyle}>
                <textarea
                  style={{
                    width: '100%', height: 120, padding: '8px 10px',
